...
<!--Inicio elementos contenedor-->
		...
		<?php
			...
			$result_msg_contatos = " SELECT  nombre_producto , sum( detalle_factura.cantidad ) AS total, year(facturas.fecha_factura) AS year,
 ...
 group by nombre_producto, year order by year(facturas.fecha_factura)";
		...
		<div class="container theme-showcase" role="main">
			...
			<div class="row espaco">
			 ...
			 <center>		<a href="../SGP2/archivosExcel/GenerarExcelEspecie.php"><button type='button' class='btn btn-sm btn-primary'>Generar Excel</button></a></center>
					...
					<table class="table">
						...
						<tbody>
							<?php while($row_msg_contatos = mysqli_fetch_assoc($resultado_msg_contatos)){?>
								<tr>
									 <td ><?php echo $row_msg_contatos["nombre_producto"]; ?></td>
								    <td class="text-left"><?php echo $row_msg_contatos["total"]; ?></td>
