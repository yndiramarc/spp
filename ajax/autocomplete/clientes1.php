...
if ($con)
{
	...
	while ($row = mysqli_fetch_array($fetch)) {
		...
		$row_array['status_cliente']=$row['status_cliente'];

	    $row_array['eslora']=$eslora;
		$row_array['manga']=$row['manga'];
		$row_array['puntal']=$row['puntal'];
		$row_array['construccion']=$row['construccion'];
		$row_array['uab']=$row['uab'];
		$row_array['capacidad_bodega']=$row['capacidad_bodega'];
