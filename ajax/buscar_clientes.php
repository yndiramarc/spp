<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $aColumns = array('nombre_cliente','telefono_cliente' ,'direccion_cliente'  );//Columnas de busqueda
		 $sTable = "clientes";
		 $sWhere = "";
		if ( $_GET['q'] != "" )
		{
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
                        ...
                        $uab=$row['uab'];
						$capacidad_bodega=$row['capacidad_bodega'];
					...
					<input type="hidden" value="<?php echo $eslora;?>" id="eslora<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $manga;?>" id="manga<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $puntal;?>" id="puntal<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $construccion;?>" id="construccion<?php echo $id_cliente;?>">
					<input type="hidden" value="<?php echo $uab;?>" id="uab<?php echo $id_cliente;?>">
	                <input type="hidden" value="<?php echo $capacidad_bodega;?>" id="capacidad_bodega<?php echo $id_cliente;?>">
					...
					<tr>
						...
						<td><?php echo $eslora; ?></td>
						<td><?php echo $manga; ?></td>
						<td ><?php echo $puntal; ?></td>
						<td><?php echo $construccion;?></td>
						<td><?php echo $uab;?></td>
						<td><?php echo $capacidad_bodega;?></td>
					...
					<a href="#" class='btn btn-default' title='Editar Embarcacion' onclick="obtener_datos('<?php echo $id_cliente;?>');" data-toggle="modal" data-target="#myModal2"><i class="glyphicon glyphicon-edit"></i></a> 
					<a href="#" class='btn btn-default' title='Borrar Embarcacion' onclick="eliminar('<?php echo $id_cliente; ?>')"><i class="glyphicon glyphicon-trash"></i> </a></span></td>
				...
				<tr>
					...
					?></span></td>
			  			...
			  			<a href="./mvc/report/report-word.php" class="btn btn-default"><i class="fa fa-download"> Descargar (.docx)</i></a>
