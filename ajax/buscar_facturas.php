			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class='text-center' >
					...
					<th class='text-center'>Arte de Pesca </th>
				...
				while ($row=mysqli_fetch_array($query)){
						...
						if ($condiciones==0){$text_estado="Cañera";}
					...
					<tr class='text-center'>
						...
						<td><a href="#" data-toggle="tooltip" data-placement="top" title="<i class='glyphicon glyphicon-list-alt'></i> <?php echo $telefono_cliente;?><br><i class='glyphicon glyphicon-tags'></i>  <?php echo $email_cliente;?> " ><?php echo $nombre_cliente;?></a></td>
