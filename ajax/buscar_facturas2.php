	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
         $q = mysqli_real_escape_string($con,(strip_tags($_REQUEST['q'], ENT_QUOTES)));
		  $sTable = "facturas, clientes, users, detalle_factura";
		 $sWhere = "";
		 $sWhere.=" WHERE facturas.id_cliente=clientes.id_cliente and facturas.id_vendedor=users.user_id and detalle_factura.numero_factura=facturas.numero_factura";
		if ( $_GET['q'] != "" )
		{
			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><class="label <?php echo $label_class;?>"><?php echo $text_estado; ?></td>
						<td><span class="label <?php echo $label_class;?>"><?php echo $cantidad; ?></span></td>
