<?php
	...
	if (isset($_GET['id_factura']))
	{
		...
		{
			header("location: desembarques.php");
			exit;	
		}
	} 
	else 
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Editar Desembarque</h4>
		</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<select class='form-control input-sm ' id="condiciones" name="condiciones">
									<option value="0" <?php if ($condiciones==0){echo "selected";}?>>Cañera</option>
									<option value="1" <?php if ($condiciones==1){echo "selected";}?>>Palangrero</option>
									<option value="2" <?php if ($condiciones==2){echo "selected";}?>>Polivalente</option>
									<option value="3" <?php if ($condiciones==43){echo "selected";}?>>Cerquera</option>
								</select>
							</div>
