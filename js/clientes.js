 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
            ...
            var eslora = $("#eslora"+id).val();
			var manga = $("#manga"+id).val();
			var puntal = $("#puntal"+id).val();
			var construccion = $("#construccion"+id).val();
			var uab = $("#uab"+id).val();
			var capacidad_bodega = $("#capacidad_bodega"+id).val();
            ...
            $("#mod_eslora").val(eslora);
			$("#mod_manga").val(manga);
			$("#mod_puntal").val(puntal);
			$("#mod_construccion").val(construccion);
			$("#mod_uab").val(uab);
			$("#mod_capacidad_bodega").val(capacidad_bodega);
