...
class PacientData {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (id_factura,numero_factura,fecha_factura,id_cliente,id_vendedor,condiciones,total_venta,estado_factura,created_at) ";
		$sql .= "value (\"$this->id_factura\",\"$this->numero_factura\",\"$this->fecha_factura\",\"$this->id_cliente\",\"$this->id_vendedor\",\"$this->condiciones\",\"$this->total_venta\",\"$this->estado_factura\",$this->created_at)";
		Executor::doit($sql);
	}
