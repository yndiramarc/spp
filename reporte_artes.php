   ...
   <div class="container">
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <h4><i class='glyphicon glyphicon-file'></i> Reportes Artes de Pesca</h4>
        </div>
...
and products.id_producto = detalle_factura.id_producto
 ...
 <div class="col-lg-14">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bell fa-fw"></i> Desembarques por Pesqueria
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
             ...
             <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php
                    include("conexion.php");
                    $query1= 'SELECT year(fecha_factura) as year, condiciones, count(facturas.condiciones) as total FROM `facturas` WHERE year(fecha_factura)=2016
group by condiciones order by condiciones ';  
...
group by condiciones order by condiciones';  
                    ...
                    while($row = mysqli_fetch_array($result1, MYSQLI_ASSOC))
                    {
                     ...
                     $desembarques1 = $desembarques1 + $row["total"];
 ...
 if ($j==0)  
                        {
                              echo "<td>".$year;
                                 echo "<td class='text-center'>".$desembarques1;
                        }

                        $a++;
                  echo "<td class='text-center'>".$datos[$j];
...
group by condiciones order by condiciones ';  
  ...
  $query1 = 'SELECT year(fecha_factura) as year, condiciones, count(facturas.condiciones) as total FROM `facturas` WHERE year(fecha_factura)=2017
...
group by condiciones order by condiciones ';  
  ...
  $query1 = 'SELECT year(fecha_factura) as year, condiciones, count(facturas.condiciones) as total FROM `facturas` WHERE year(fecha_factura)=2018
