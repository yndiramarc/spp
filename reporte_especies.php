...
$(function () {
    $('#container').highcharts({
        ...
        $sql=mysql_query("SELECT products.nombre_producto, sum( detalle_factura.cantidad ) AS total, year(facturas.fecha_factura) as year
                        ...
                        GROUP BY products.nombre_producto order by total ");
...
<br><br>
               ...
               <div class="col-lg-14">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bell fa-fw"></i> Principales Especies Por Su Valor Comercial
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="list-group">
                    ...
                    $query = 'SELECT products.nombre_producto,sum( facturas.total_venta ) AS totalV, sum( detalle_factura.cantidad ) AS total, year(facturas.fecha_factura) as year
                        FROM detalle_factura, products, facturas
                        WHERE detalle_factura.id_producto = products.id_producto  and nombre_producto="sardina"  
                        and  year(facturas.fecha_factura)= year(curdate())
  ...
  $query1 = 'SELECT products.nombre_producto,sum( facturas.total_venta ) AS totalV, sum( detalle_factura.cantidad ) AS total, year(facturas.fecha_factura) as year
                        FROM detalle_factura, products, facturas
                        WHERE detalle_factura.id_producto = products.id_producto  and nombre_producto="sardina"  and  year(facturas.fecha_factura)= year(curdate())
                        GROUP BY products.nombre_producto ';  
              ...
              echo "<td>".$year;
                       ...
                       echo "<td class='text-center'>".number_format(($datos[$j]), 2, ',', '.');
                       echo "<td class='text-center'>".number_format(($datos1[$j]), 2, ',', '.');
                    ...
                    <?php
                    include("conexion.php");
                    $query1= 'SELECT products.nombre_producto,sum( facturas.total_venta ) AS totalV1, 
                    sum( detalle_factura.cantidad ) AS total1, year(facturas.fecha_factura) as year
                        FROM detalle_factura, products, facturas
                        WHERE detalle_factura.id_producto = products.id_producto  and nombre_producto="ATUN ALETA AMARILLA"  and  year(facturas.fecha_factura)= year(curdate())
                        GROUP BY products.nombre_producto ';  
  ...
  echo "<td>".$year;
   ...
   <?php
                    ...
                    sum( detalle_factura.cantidad ) AS total1, year(facturas.fecha_factura) as year
                        FROM detalle_factura, products, facturas
                        WHERE detalle_factura.id_producto = products.id_producto  and nombre_producto="pepitona"  and  year(facturas.fecha_factura)= year(curdate())
                        GROUP BY products.nombre_producto ';  
 ...
 <?php
                    ...
                    sum( detalle_factura.cantidad ) AS total1, year(facturas.fecha_factura) as year
                        FROM detalle_factura, products, facturas
                        WHERE detalle_factura.id_producto = products.id_producto  and nombre_producto="TAHALI"  and  year(facturas.fecha_factura)= year(curdate())
                        GROUP BY products.nombre_producto ';  
  ...
  echo "<td>".$year;
     ...
     <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bell fa-fw"></i> Principales Especies Por Su Aportacion En Kg
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="list-group">
            ...
            for ($j=0;$j<=$c-1;$j++)
            {
              ...
              echo "<td>".$year;
                     echo "<td class='text-center'>".number_format(($datos[$j]), 0, ',', '.');
...
<center> <a href="../SGP2/archivosExcel/GenerarExcelEspeciesAportacion.php"><button type='button' class='btn btn-sm btn-primary' class="text-center">Generar Excel</button></a></center>
     <!-- /.list-group -->
                         </div>
          ...
          <!-- /.panel -->
                ...
                <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                                <div class="panel-heading">
                                    <i class="fa fa-bar-chart-o fa-fw"></i> Descarga Especies por Año
