 <?php
    ...
    /* Connect To Database*/
    require_once ("C:\wamp\www\SGP2/config/db.php");//Contiene las variables de configuracion para conectar a la base de datos
    require_once ("C:\wamp\www\SGP2/config/conexion.php");//Contiene funcion que conecta a la base de datos
