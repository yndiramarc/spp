  ...
  <body>
    ...
    <div class="container">
		...
		<div class="panel-heading">
			...
			<?php
			include("modal/registro_usuarios1.php");
			include("modal/editar_usuarios1.php");
			include("modal/cambiar_password1.php");
			?>
	...
	include("footer.php");
	?>
	<script type="text/javascript" src="js/usuarios1.js"></script>
